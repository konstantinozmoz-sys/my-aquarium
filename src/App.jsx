  ...
  const DoctorView = () => {
    ...
    const identifyDisease = async (e) => {
        ...
        try {
            ...
            setResult(cleanResult || "Не удалось получить диагностические данные.");
        } catch (e) { 
